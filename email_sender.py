...
while True:
    ...
    runtimes[datetime.datetime.weekday(datetime.datetime.today())] = end - start
    avg_runtime = sum(runtimes.values())/len(runtimes.values())
    print(runtimes)
    print('Average Runtime is ' + str(avg_runtime))

    time.sleep(86400 - avg_runtime)
