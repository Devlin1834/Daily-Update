...
## So a couple weeks after writing this I was looking over it and wondering why I took all those extra lines
## to make functions instead of just putting the text in a dictionary. So i did that and realized why
## I had done it that way. The functions keep me from accessing unnnecessary APIs. For example, I don't
## need to use alpha vantages API on tuesday, this aproach means that I only take time gathering what
## I need for that day
...
if not events:
    ...
    events_text = "\nHere is today's schedule: " + ', '.join(events)
